...
public class AttrController {
    ...
    public ResponseVo<List<AttrEntity>> getAttrByCidTypeAndSearchType(@PathVariable("categoryId") Long categoryId,
                                                                              @RequestParam(value = "type", required = false) Integer type,
                                                                              @RequestParam(value = "searchType", required = false) Integer searchType) {

        List<AttrEntity> attrEntities = attrService.getAttrByCidTypeAndSearchType(categoryId, type, searchType);
    ...
    public ResponseVo<List<AttrEntity>> attrEntityById(@PathVariable("groupId") Long groupId) {
